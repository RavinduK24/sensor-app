...
const CameraDemo = ({ customerType, onCustomerTypeChange }) => {
  ...
  const customerProfiles = [
    {
      type: 'Young Professionals (Working from Home)',
      description: 'Needs bright, productivity focused spaces',
      icon: '💼'
    },
    {
      type: 'Families with Babies/Toddlers',
      description: 'Prefers gentle temperatures & soft light',
      icon: '👶'
    },
    {
      type: 'Elderly Residents',
      description: 'Enjoys warmer rooms and clean air',
      icon: '🧓'
    },
    {
      type: 'Allergy/Asthma Sufferers',
      description: 'Requires pristine air and balanced humidity',
      icon: '🌿'
    }
  ];
